...
TOKEN = "BBFF-5Dg1cLsTsTi2z0HWREUd01dIr10XgK"# Put your TOKEN here
DEVICE_LABEL = "demo"  # Put your device label here 
VARIABLE_LABEL_1 = "temperature"  # Put your first variable label here
VARIABLE_LABEL_2 = "rangeorganic"  # Put your second variable label here
VARIABLE_LABEL_3 = "rangenonorganic"  # Put your second variable label here
VARIABLE_LABEL_4 = "position"

def build_payload(variable_1, variable_2, variable_3, variable_4):
    # Creates two random values for sending data
    value_1 = random.randint(15, 40)
    value_2 = random.randint(0, 85)
    value_3 = random.randint(0,85)
    value_4 = random.randint(20,40)
